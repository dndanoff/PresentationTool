 ...
 * @author x
 */
public class PresentationUDPServerScreen extends javax.swing.JFrame {

    private List<String> availableAddresses;
    private String selectedAddress;
    private Thread serverThread;
    private PresentationUDPServer server;

    /**
     * Creates new form PresentationServer
     */
    public PresentationUDPServerScreen() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PresentationUDPServerScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new PresentationUDPServerScreen().setVisible(true);
            }
        });
    }
